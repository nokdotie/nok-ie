...
{#if null !== clickedIndex}
	<div class="fixed inset-0 bg-black/90 backdrop-blur p-3 flex justify-center items-center">
		<div class="max-w-full max-h-full overflow-y-scroll">
			...
			<img src={advert.propertyImageUrls[clickedIndex]} alt="" />
			<div class="flex justify-between group pt-3">
				<button
